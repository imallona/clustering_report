...
This version globs results instead of getting them from a `metrics file` or arguments. Due to the active development of [PR 45](https://github.com/omnibenchmark/omnibenchmark/pull/45).
...
prettify_run <- function(x, slot) {
    ## 1 would be the stage and ## 3 the param_x encoding, so discarded
    return(paste(x$run[[slot]][2], x$run[[slot]][4]))
}
